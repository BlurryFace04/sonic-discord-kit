          ...
          <form onSubmit={handleTransfer}>
            <div className="grid w-full items-center gap-4">
              <div className="flex flex-col space-y-1.5">
                ...
                <pre className="text-sm font-ny">{walletAddress}</pre>
              </div>
              <div className="flex flex-col space-y-1.5">
                  ...
                  tokenBalances.splTokens.map((token, idx) => (
                    <div key={idx} className="mt-2 border p-2 rounded space-y-1">
                      ...
                      <div className="flex items-center space-x-2">
                        <Label>Mint:</Label>
                        <pre className="text-sm font-ny">{token.mint}</pre>
                      </div>
            ...
            <div className="mt-4">
              ...
              {mintedAsset && (
                <div className="mt-2 border p-2 rounded overflow-auto" style={{ maxWidth: '100%', whiteSpace: 'pre-wrap' }}>
                  <pre className="text-sm font-ny overflow-x-auto">{JSON.stringify(mintedAsset, null, 2)}</pre>
                </div>
              )}
            </div>
          )}
        ...
        <CardContent>
          ...
          {collectionDeployTxHash && (
            <div className="mt-4">
              ...
              {deployedCollection && (
                <div className="mt-2 border p-2 rounded overflow-auto" style={{ maxWidth: '100%', whiteSpace: 'pre-wrap' }}>
                  <pre className="text-sm font-ny overflow-x-auto">{JSON.stringify(deployedCollection, null, 2)}</pre>
                </div>
              )}
            </div>
          )}
          ...
          {collectionMintTxHash && (
            <div className="mt-4">
              ...
              {mintedCollectionAsset && (
                <div className="mt-2 border p-2 rounded overflow-auto" style={{ maxWidth: '100%', whiteSpace: 'pre-wrap' }}>
                  <pre className="text-sm font-ny overflow-x-auto">{JSON.stringify(mintedCollectionAsset, null, 2)}</pre>
                </div>
              )}
            </div>
          )}
                ...
                nfts.map((nft, idx) => (
                  <div key={idx} className="mt-2 border p-2 rounded overflow-x-auto">
                    <div className="min-w-max space-y-1">
                      ...
                      <div className="flex items-center space-x-2">
                        <Label>Mint:</Label>
                        <pre className="text-sm font-ny">{nft.publicKey}</pre>
                      </div>
                      <div className="flex items-center space-x-2">
                        <Label>URI:</Label>
